    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GrassSeeds", x => x.Id);
                });
            ...
            migrationBuilder.InsertData(
                table: "GrassSeeds",
                columns: new[] { "Id", "Category", "IsVisible", "Name", "Price", "Variety" },
                values: new object[,]
                {
                    { 1, "Однолетние и многолетние травы", true, "Люцерна синяя", "450", "Сирена ЭС, Артемида ЭС, Верко РС-1" },
                    { 20, "Однолетние и многолетние травы", true, "Пырей ползучий", "140", "" },
                    { 19, "Однолетние и многолетние травы", true, "Лядвенец рогатый", "договраня", "Солнышко РС-1" },
                    { 18, "Однолетние и многолетние травы", true, "Суданская трава", "50", "Кинельская 100 РС-1" },
                    { 17, "Однолетние и многолетние травы", true, "Ежа сборная", "180", "Вик 61 РС-1" },
                    { 16, "Однолетние и многолетние травы", true, "Мятлик луговой", "600", "БАЛИН РС-1" },
                    { 15, "Однолетние и многолетние травы", true, "Клевер полз. Белый", "750", "РЕВЕНДЕЛ" },
                    { 14, "Однолетние и многолетние травы", true, "Тимофеевка", "170", "Псковская местная РС-1" },
                    { 12, "Однолетние и многолетние травы", true, "Овсяница красная", "280", "Бореал РС-2" },
                    { 11, "Однолетние и многолетние травы", true, "Овсяница тростниковая", "190", "Липальма" },
                    { 13, "Однолетние и многолетние травы", true, "Тимофеевка луговая", "170", "Ленинградская 204" },
                    { 9, "Однолетние и многолетние травы", true, "Райграс однолетний", "120", "Рапид" },
                    { 8, "Однолетние и многолетние травы", true, "Райграс пастбищный", "170", "Вик 66 РС-2" },
                    { 7, "Однолетние и многолетние травы", true, "Кострец безостый", "220", "Сибниисхоз 189 РС-1" },
                    { 6, "Однолетние и многолетние травы", true, "Пайза", "50", "Красава ЭС" },
                    { 5, "Однолетние и многолетние травы", true, "Эспарцет", "55", "Песчаный 1251 РС-3" },
                    { 4, "Однолетние и многолетние травы", true, "Фацелия", "220", "" },
                    { 3, "Однолетние и многолетние травы", true, "Фестулолиум", "190", "Вик 90 РС-1" },
                    { 2, "Однолетние и многолетние травы", true, "Клевер луговой", "180, 240", "Трио РС-1, ЭС" },
                    { 10, "Однолетние и многолетние травы", true, "Овсяница луговая", "170", "Свердловская 37 РС-1" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 9, "Зерновые и зернобобовые культуры", true, "Вика/Горох/Овес 25/20/55", "25", "" },
                    { 13, "Зерновые и зернобобовые культуры", true, "Пшеница яровая", "25", "Дарья РС-1" },
                    { 12, "Зерновые и зернобобовые культуры", true, "Соя", "", "Мезенка РС-1" },
                    { 11, "Зерновые и зернобобовые культуры", true, "Горчица белая", "40", "Рапсодия РСт" },
                    { 10, "Зерновые и зернобобовые культуры", true, "Овес", "17, 24", "Скакун РС-1, ЭС" },
                    { 8, "Зерновые и зернобобовые культуры", true, "Горох/Овес 40/60", "24", "" },
                    { 5, "Зерновые и зернобобовые культуры", true, "Гречиха", "", "Темп ЭС" },
                    { 6, "Зерновые и зернобобовые культуры", true, "Вика / Овес 30/70", "23", "Никольская РС-2/Скакун РС-1" },
                    { 4, "Зерновые и зернобобовые культуры", true, "Горох", "35", "Пелюшка РСт" },
                    { 3, "Зерновые и зернобобовые культуры", true, "Горох", "35, 40", "Усатый кормовой РС-2" },
                    { 2, "Зерновые и зернобобовые культуры", true, "Горох посевной", "35, 40", "Фараон РС-1, Софья ЭС" },
                    { 1, "Зерновые и зернобобовые культуры", true, "Вика яровая", "35", "Никольская РС-2" },
                    { 7, "Зерновые и зернобобовые культуры", true, "Горох/Овес 30/70", "23", "" }
                });
